...
//        ArrayList<String> courseDataSet = new ArrayList<>(Arrays.asList(CourseSpinner));
//
//        Spinner studentsSpinner = findViewById(R.id.students_spinner);
//        CourseAdapter adapter = new CourseAdapter(this, R.layout.activity_course_spinner, courseDataSet);
